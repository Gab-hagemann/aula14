...
pink_balloonImage.addImage("pink_balloonImage");
  ...
  blue_balloonImage.addImage("blue_balloon0.png");
...
function greenBalloon() {
  //crieSprite para o balão
  greenBalloon = createSprite(0,0,100,100);
  //adicioneImagem para o balão
  green_balloonImage.addImage("green_balloonImage");
  // adicione velocidade para fazer o balão se mover
  green_balloonImage.velocityY = 1;
  // mudar a dimensão do balão
  // atriubua tempo de vida ao balão
}
...
function pinkBalloon() {
 //crieSprite para o balão
 pinkBalloon = createSprite(0,0,100,100);
  //adicioneImagem para o balão
  pink_balloonImage.addImage("pink_balloonImage");
  // adicione velocidade para fazer o balão se mover
